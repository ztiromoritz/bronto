var MESSAGES_BRONTO_INIT = [
    ...
    "I looked at the sky. And suddenly a light brightened the night.",

    "It moved across the firmament towards the wild lands.",

    "The light disappeared from my sight. Half an hour later, i heard an enormous thunder and the night was brightened again in a flash of light.",

    "My friend {{playername}}, you are known to be one of the fastest around here.",
